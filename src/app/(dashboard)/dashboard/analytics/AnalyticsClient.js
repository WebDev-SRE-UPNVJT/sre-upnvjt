        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2.5 px-5 py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white text-xs md:text-sm font-bold transition-all shadow-[0_4px_20px_rgba(16,185,129,0.25)] hover:shadow-[0_6px_25px_rgba(16,185,129,0.35)] cursor-pointer shrink-0"
            >

            ...
            <div className="space-y-16">
              ...
              {filteredUpcoming.length > 0 && (
                <div>
                  ...
                  <div className="flex overflow-x-auto pb-6 gap-5 scrollbar-none snap-x snap-mandatory flex-nowrap justify-start max-w-full w-[calc(100%+1.5rem)] -mr-6 pr-6 sm:w-full sm:mr-0 sm:pr-0 sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 sm:gap-6 justify-items-center">
